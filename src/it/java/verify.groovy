...
assert text.contains("[INFO] build.environment.java.version=")
assert text.contains("[INFO] build.environment.java.specification.name=")
assert text.contains("[INFO] build.environment.java.specification.version")
assert text.contains("[INFO] build.environment.java.runtime.name")
assert text.contains("[INFO] build.environment.java.runtime.version")
assert text.contains("[INFO] build.environment.java.vendor=")
assert text.contains("[INFO] build.environment.java.vm.name=")
assert text.contains("[INFO] build.environment.java.vm.info=")
assert text.contains("[INFO] build.environment.java.vm.specification.name=")
assert text.contains("[INFO] build.environment.java.vm.specification.vendor=")
assert text.contains("[INFO] build.environment.java.vm.specification.version=")
assert text.contains("[INFO] build.environment.sun.management.compiler=")
